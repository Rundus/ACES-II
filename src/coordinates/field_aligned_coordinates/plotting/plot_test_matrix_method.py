...
data_dict_mag_FAC_old =stl.loadDictFromFile('C:\Data\ACESII\L2\high\ACESII_36359_l2_RingCore_Field_Aligned_OLD.cdf')
...
B_FAC = np.array([data_dict_mag_FAC_old['B_e'][0],data_dict_mag_FAC_old['B_p'][0],data_dict_mag_FAC_old['B_r'][0]]).T
...
# ax[0].scatter(data_dict_mag_FAC_old['Epoch'][0],data_dict_mag_FAC_old['B_e'][0],color='tab:blue',s=20)
# ax[0].scatter(data_dict_mag_ENU['Epoch'][0],B_FAC_new[:,0],color='tab:red',s=10)
ax[0].plot(data_dict_mag_ENU['Epoch'][0], data_dict_mag_FAC_old['B_e'][0]-B_FAC_new[:,0])

# ax[1].scatter(data_dict_mag_FAC_old['Epoch'][0],data_dict_mag_FAC_old['B_p'][0],color='tab:blue',s=20)
# ax[1].scatter(data_dict_mag_ENU['Epoch'][0],B_FAC_new[:,1],color='tab:red',s=10)
ax[1].plot(data_dict_mag_ENU['Epoch'][0], data_dict_mag_FAC_old['B_p'][0]-B_FAC_new[:,1])

# ax[2].scatter(data_dict_mag_FAC_old['Epoch'][0],data_dict_mag_FAC_old['B_r'][0],color='tab:blue',s=20)
# ax[2].scatter(data_dict_mag_ENU['Epoch'][0],B_FAC_new[:,2],color='tab:red',s=10)
ax[2].plot(data_dict_mag_ENU['Epoch'][0], data_dict_mag_FAC_old['B_r'][0]-B_FAC_new[:,2])
