...
def DistFunc_to_ESAcurrents(wRocket, justPrintFileNames):
    ...
    inputFiles_electron = glob(f'{rocketFolderPath}\\L3\\DistFunc\\{ACESII.fliers[wRocket-4]}\*eepaa_fullCal.cdf*')[0]
    inputFiles_ion = glob(f'{rocketFolderPath}\\L3\\DistFunc\{ACESII.fliers[wRocket-4]}\*iepaa_fullCal.cdf*')[0]

    if justPrintFileNames:
        print('Electron Files')
        print(inputFiles_electron)
        print('Ion Files')
        print(inputFiles_ion)
        return
