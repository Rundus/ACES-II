...
def csv_to_cdf_trajectories(wRocket):
    ...
    specialMods = {
        ...
        'ECEFXPOS': {'UNITS': 'm', 'DEPEND_0': 'Epoch', 'LABLAXIS': 'ECEFXPOS'},
        'ECEFXVEL': {'UNITS': 'm/s', 'DEPEND_0': 'Epoch', 'LABLAXIS': 'ECEFXVEL'},
        'ECEFYPOS': {'UNITS': 'm', 'DEPEND_0': 'Epoch', 'LABLAXIS': 'ECEFYPOS'},
        'ECEFYVEL': {'UNITS': 'm/s', 'DEPEND_0': 'Epoch', 'LABLAXIS': 'ECEFYVEL'},
        'ECEFZPOS': {'UNITS': 'm', 'DEPEND_0': 'Epoch', 'LABLAXIS': 'ECEFZPOS'},
    ...
    if outputData:
        ...
        fileoutName = f'ACESII_{ACESII.payload_IDs[wRocket-4]}_GPS_trajectory_ECEF.cdf'
