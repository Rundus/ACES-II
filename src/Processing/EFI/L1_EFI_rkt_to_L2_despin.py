...
def EFI_rkt_to_ENU_despin(wRocket):
    ...
    vxB_ENU_vec = np.array([data_dict_cal['DCM'][0][idx]@vec for idx,vec in enumerate(vxB_rkt_vec)])
    ...
    if outputData:
        ...
        fileoutName = f'ACESII_{ACESII.payload_IDs[wRocket-4]}_l2_EFI_ENU_withVxB.cdf'
