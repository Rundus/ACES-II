...
class ACESII:
    ...
    # 'LPFixed_calResistances': [
    #     {'Open': 165, 500000000: 2170, 250000000: 2308, 100000000: 2540, 50000000: 2710, 10000000: 3122, 5000000: 3299},
    #     {'Open': 165, 500000000: 2063, 250000000: 2260, 100000000: 2500, 50000000: 2660, 10000000: 3060,
    #      5000000: 3194}],
    ...
    # 'LPswept_cal_resistances': [10 * 10 ** (9), 500 * 10 ** (6), 250 * 10 ** (6), 100 * 10 ** (6), 50 * 10 ** (6),
    #                             10 * 10 ** (6), 5 * 10 ** (6)],
    ...
    # 'Epoch_range_to_determine_stepDAC': [
    #     [dt.datetime(2022, 11, 20, 17, 24, 30, 300000), dt.datetime(2022, 11, 20, 17, 25, 10, 310000)],
    #     [dt.datetime(2022, 11, 20, 17, 24, 30, 440000), dt.datetime(2022, 11, 20, 17, 25, 10, 450000)]],
    # 'startEndLangmuirBreakIntoCurves': [
    #     [dt.datetime(2022, 11, 20, 17, 21, 00, 890000), dt.datetime(2022, 11, 20, 17, 29, 57, 700000)],
